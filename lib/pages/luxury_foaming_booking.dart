...
class LuxuryFoamingBookingScreen extends StatefulWidget {
  @override
  _LuxuryFoamingBookingScreenState createState() =>
      _LuxuryFoamingBookingScreenState();
}

class _LuxuryFoamingBookingScreenState extends State<LuxuryFoamingBookingScreen> {
  String customerName = "";
  String telephone = "";
  String carDetail = "";
  String carTargo = "";
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double totalPrice = 0;
    if (widget.option1) totalPrice += 10; // Price for Foaming
...
void main() {
  runApp(MaterialApp(
    home: LuxuryFoamingBookingScreen(),
  ));
}}