...
class LuxuryOilChangeBookingScreen extends StatefulWidget {
  @override
  _LuxuryOilChangeBookingScreenState createState() =>
      _LuxuryOilChangeBookingScreenState();
}
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.option2) totalPrice += 10; // Price for Foaming
