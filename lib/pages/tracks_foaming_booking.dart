...
class TracksFoamingBookingScreen extends StatefulWidget {
  @override
  _TracksFoamingBookingScreenState createState() =>
      _TracksFoamingBookingScreenState();
}

class _TracksFoamingBookingScreenState extends State<TracksFoamingBookingScreen> {
  String customerName = "";
  String telephone = "";
  String carDetail = "";
  String carTargo = "";
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double totalPrice = 0;
    if (widget.option1) totalPrice += 16; // Price for foaming
...
void main() {
  runApp(MaterialApp(
    home: TracksFoamingBookingScreen(),
  ));
}
}