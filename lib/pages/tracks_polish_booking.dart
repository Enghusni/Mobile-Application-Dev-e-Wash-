...
class TracksPolishBookingScreen extends StatefulWidget {
  @override
  _TracksPolishBookingScreenState createState() =>
      _TracksPolishBookingScreenState();
}

class _TracksPolishBookingScreenState extends State<TracksPolishBookingScreen> {
  String customerName = "";
  String telephone = "";
  String carDetail = "";
  String carTargo = "";
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double totalPrice = 0;
    if (widget.option1) totalPrice += 30; // Price for Polishing
...
void main() {
  runApp(MaterialApp(
    home: TracksPolishBookingScreen(),
  ));
}
