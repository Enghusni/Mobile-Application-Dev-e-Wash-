...
class TrackOilChangeBookingScreen extends StatefulWidget {
  @override
  _TrackOilChangeBookingScreenState createState() =>
      _TrackOilChangeBookingScreenState();
}

class _TrackOilChangeBookingScreenState extends State<TrackOilChangeBookingScreen> {
  String customerName = "";
  String telephone = "";
  String carDetail = "";
  String carTargo = "";
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double totalPrice = 0;
    if (widget.option1) totalPrice += 16; // Price for Oil Change
    if (widget.option2) totalPrice += 8; // Price for Foaming
...
void main() {
  runApp(MaterialApp(
    home: TrackOilChangeBookingScreen(),
  ));
}
