...
class LuxuryPolishBookingScreen extends StatefulWidget {
  @override
  _LuxuryPolishBookingScreenState createState() =>
      _LuxuryPolishBookingScreenState();
}

class _LuxuryPolishBookingScreenState extends State<LuxuryPolishBookingScreen> {
  String customerName = "";
  String telephone = "";
  String carDetail = "";
  String carTargo = "";
...
class _ConfirmationScreenState extends State<ConfirmationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double totalPrice = 0;
    if (widget.option1) totalPrice += 20; // Price for Polishing
...
void main() {
  runApp(MaterialApp(
    home: LuxuryPolishBookingScreen(),
  ));
}
